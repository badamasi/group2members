...
public class BankSystem extends JFrame implements ActionListener, ItemListener {
	...
	public BankSystem () {
		...
		super ("Automated Banking System.");
		...
		author = new JLabel (" " + "Automated Banking System (ABS)", Label.LEFT);
	...
	String makeRecordPrint (int rec) {
		...
		String data;
		String data0 = "               Automated Banking system.               \n";	//Page Title.
		...
		String data6 = "          Copyright © 2016 Badamasi Yusuf.\n";	//Page Footer.
		String sep0 = " -----------------------------------------------------------\n";
		String sep1 = " -----------------------------------------------------------\n";
		String sep2 = " -----------------------------------------------------------\n";
		String sep3 = " -----------------------------------------------------------\n";
